              ...
              <div className="space-y-4">
                {isPaymentSuccess ? (
                  ...
                  <>
                    ...
                    <div className="mb-4 rounded-lg p-4 flex items-center gap-3" style={{ backgroundColor: '#E9D5FF' }}>
                      <div className="w-6 h-6 flex-shrink-0 flex items-center justify-center" style={{ color: '#7C3AED' }}>
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium" style={{ color: '#4B5563' }}>
                          Promo Code <span className="font-bold">SOULMATEGURULINK93</span> Applied
                        </p>
