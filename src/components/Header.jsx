    ...
    <header className="bg-white shadow-sm sticky top-0 z-50 border-b" style={{ borderColor: 'rgba(212, 163, 75, 0.2)' }}>
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-2 sm:py-3 md:py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3 cursor-pointer" onClick={() => navigate('/')} role="button" tabIndex={0} onKeyDown={(e) => e.key === 'Enter' && navigate('/')} aria-label="Go to homepage">
            <img src="/logoicon.png" alt="GuruLink logo" className="h-6 w-6 sm:h-8 sm:w-8 object-contain notranslate" width="32" height="32" />
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <button 
              ...
              aria-label="Sign up for GuruLink"
            >
              Sign Up
            </button>
          </div>
