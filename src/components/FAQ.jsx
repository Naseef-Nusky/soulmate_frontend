...
const faqs = [
  ...
  },
  {
    ...
    a: (
      <>
        GuruLink operates on a subscription model. Your 7-day trial is available for £0.99* and includes full access to all features.
        <br /><br />
        You may cancel anytime during the trial with no further charges.
        <br /><br />
        If you continue, your subscription will automatically renew at the monthly rate of £14.99*.
        <br /><br />
